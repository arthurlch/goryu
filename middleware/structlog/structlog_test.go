...
func TestStructlogMiddleware(t *testing.T) {
	t.Run("BasicLogging", func(t *testing.T) {
		...
		if err := _ = json.Unmarshal([]byte(logOutput), &logEntry); err != nil {
	...
	t.Run("RequestIDFromHeader", func(t *testing.T) {
		...
		// Check response contains the request ID
...
func TestLogHelpers(t *testing.T) {
	t.Run("LogInfo", func(t *testing.T) {
		...
		// Parse the info log entry (first line)
		var infoEntry map[string]interface{}
		if err := _ = json.Unmarshal([]byte(lines[0]), &infoEntry); err != nil {
	...
	t.Run("CorrelatedLogger", func(t *testing.T) {
		...
		// Parse the correlated log entry (first line)
		var correlatedEntry map[string]interface{}
		if err := _ = json.Unmarshal([]byte(lines[0]), &correlatedEntry); err != nil {
